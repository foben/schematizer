...
public class TrainingDataPurger {
	...
	public static void main(String[] args) throws RDFParseException, RepositoryException, IOException, InterruptedException {
...
//		con.add(new File(schemaFileLDSpider), null, RDFFormat.NQUADS, (Resource)null);
		con.add(new File(FILE_SCHEMADATA_LOVS_COMBINED), null, RDFFormat.NQUADS, (Resource)null);
		...
		RepositoryResult<Statement> res =repo.getStatements((String) null, "http://www.w3.org/2002/07/owl#equivalentClass", (String)null, (String)null);
		//RepositoryResult<Statement> res = con.getStatements((Resource) null, new URIImpl("http://www.w3.org/2002/07/owl#equivalentClass"), (Value) null, false, (Resource)null);
		int results = 0;
