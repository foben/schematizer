...
import static net.foben.schematizer.Environment.DataFiles.FILE_PROPERTIES;
...
public class LOVFromTypes {
	...
	try {
	    ...
	    String queryString = "PREFIX rdf:<http://www.w3.org/1999/02/22-rdf-syntax-ns#>"
		    ...
		    + "PREFIX skos:<http://www.w3.org/2004/02/skos/core#>" + "PREFIX foaf:<http://xmlns.com/foaf/0.1/>"
		    + "PREFIX void:<http://rdfs.org/ns/void#>" + "PREFIX bibo:<http://purl.org/ontology/bibo/>"
		    + "PREFIX vann:<http://purl.org/vocab/vann/>" + "PREFIX voaf:<http://purl.org/vocommons/voaf#>"
		    + "PREFIX frbr:<http://purl.org/vocab/frbr/core#>"
		    + "PREFIX lov:<http://lov.okfn.org/dataset/lov/lov#> " + "SELECT * WHERE{ "
		    + " ?a dcterms:hasPart <%s> ." + "} limit 500000000000";
