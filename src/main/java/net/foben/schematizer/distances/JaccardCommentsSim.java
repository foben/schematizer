...
public class JaccardCommentsSim implements
	...
	@Override
	public double getSim(LabelsCommentsResourceDescriptor s,
			LabelsCommentsResourceDescriptor t) {
	...
	public double getSim(ComparableResourceDescriptor s,
		...
		if (s instanceof LabelsCommentsResourceDescriptor
				&& t instanceof LabelsCommentsResourceDescriptor) {
			return getSim((LabelsCommentsResourceDescriptor) s,
					(LabelsCommentsResourceDescriptor) t);
		}
